const API_URL = "https://j0kys7kqk4.execute-api.us-east-1.amazonaws.com/dev";
const PHOTOGALLERY_S3_BUCKET_URL = "photobucket-vwang43-2021-4150";
...
function loadDeletePhotosPage(){
    checkIfLoggedIn();
    $("#userdata-container").html("Logged in as "+sessionStorage.getItem('name')+" ("+sessionStorage.getItem('username')+")");
}

function loadUpdatePhotosPage(){
    checkIfLoggedIn();
    $("#userdata-container").html("Logged in as "+sessionStorage.getItem('name')+" ("+sessionStorage.getItem('username')+")");
}
...
function deletePhoto(){
    ...
    $.ajax({
        url: `${API_URL}/deletephoto/${filename}`,
        type: 'DELETE',
        crossDomain: true,
        statusCode: {
        200: function(data) {
...
$(document).ready(function(){
    ...
    if(pathname=='/index.html' || pathname==='/'){
        ...
        loadAddPhotosPage();
    }else if(pathname=='/deletephoto.html'){
        loadDeletePhotosPage();
    }else if(pathname=='/updatephoto.html'){
        loadUpdatePhotosPage();
